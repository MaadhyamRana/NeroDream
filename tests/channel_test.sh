...
python cli.py --model "$MODEL" --layer "features.14" --channel 0   --image images/test2.jpg --output dream.mobilenet_v2.16.0.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 1   --image images/test2.jpg --output dream.mobilenet_v2.16.1.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 4   --image images/test2.jpg --output dream.mobilenet_v2.16.4.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 8   --image images/test2.jpg --output dream.mobilenet_v2.16.8.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 16  --image images/test2.jpg --output dream.mobilenet_v2.16.16.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 32  --image images/test2.jpg --output dream.mobilenet_v2.16.32.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 64  --image images/test2.jpg --output dream.mobilenet_v2.16.64.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 96  --image images/test2.jpg --output dream.mobilenet_v2.16.96.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 128 --image images/test2.jpg --output dream.mobilenet_v2.16.128.jpg
python cli.py --model "$MODEL" --layer "features.14" --channel 159 --image images/test2.jpg --output dream.mobilenet_v2.16.159.jpg
