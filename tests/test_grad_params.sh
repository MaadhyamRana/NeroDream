...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --output dream.params.baseline.jpg
...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --octaves 1  --output dream.params.octaves.1.jpg
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --octaves 6  --output dream.params.octaves.6.jpg
...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --octave-scale 1.2 --output dream.params.octave_scale.1.2.jpg
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --octave-scale 1.8 --output dream.params.octave_scale.1.8.jpg
...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --iterations 5  --output dream.params.iterations.5.jpg
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --iterations 40 --output dream.params.iterations.40.jpg
...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --step-size 0.005 --output dream.params.step_size.0.005.jpg
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --step-size 0.03  --output dream.params.step_size.0.03.jpg
...
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --jitter 0  --output dream.params.jitter.0.jpg
python cli.py --model "$MODEL" --layer "$LAYER" --image "$IMAGE" --jitter 32 --output dream.params.jitter.32.jpg
